...
#'
#' @param U This is the effective rainfall/instantaneous runoff, which is the sum of surface runoff, overflow, interflow, and baseflow.
#' @param mid This is the model identification number (see first column of \code{modlist}).
#' @param deltim This is the input time step. By default deltim = 1 for daily steps. All options: deltim = 1 (daily time step), 1/24 (hourly time step), 1/24/4 (15 min time step).
#' @param timedelay Time delay in runoff (days).
#'
